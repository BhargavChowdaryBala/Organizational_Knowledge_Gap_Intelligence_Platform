        ...
        <div className="space-y-8 animate-fade-in-up">
          ...
          <Card>
            ...
            <div className="grid grid-cols-5 gap-4">
              <div className="bg-slate-100 dark:bg-zinc-800 p-4 rounded-xl font-bold text-sm">Department</div>
              <div className="bg-slate-100 dark:bg-zinc-800 p-4 rounded-xl font-bold text-sm">Spring Boot</div>
              <div className="bg-slate-100 dark:bg-zinc-800 p-4 rounded-xl font-bold text-sm">ReactJS</div>
              <div className="bg-slate-100 dark:bg-zinc-800 p-4 rounded-xl font-bold text-sm">Docker</div>
              <div className="bg-slate-100 dark:bg-zinc-800 p-4 rounded-xl font-bold text-sm">Kubernetes</div>

              {/* Rows */}
              <div className="p-3 border-b border-slate-100 dark:border-white/5 font-semibold text-sm">Engineering</div>
              <div className="p-3 bg-emerald-100/50 dark:bg-emerald-500/10 text-emerald-800 dark:text-emerald-400 font-bold rounded-lg text-center text-sm">0 (OK)</div>
              <div className="p-3 bg-amber-100/50 dark:bg-amber-500/10 text-amber-800 dark:text-amber-400 font-bold rounded-lg text-center text-sm">-1 (Low)</div>
              <div className="p-3 bg-rose-100/50 dark:bg-rose-500/10 text-rose-800 dark:text-rose-400 font-bold rounded-lg text-center text-sm">-3 (High)</div>
              <div className="p-3 bg-rose-100/50 dark:bg-rose-500/10 text-rose-800 dark:text-rose-400 font-bold rounded-lg text-center text-sm">-4 (Crit)</div>

              <div className="p-3 border-b border-slate-100 dark:border-white/5 font-semibold text-sm">Product</div>
              <div className="p-3 bg-emerald-100/50 dark:bg-emerald-500/10 text-emerald-800 dark:text-emerald-400 font-bold rounded-lg text-center text-sm">0 (OK)</div>
              <div className="p-3 bg-emerald-100/50 dark:bg-emerald-500/10 text-emerald-800 dark:text-emerald-400 font-bold rounded-lg text-center text-sm">0 (OK)</div>
              <div className="p-3 bg-amber-100/50 dark:bg-amber-500/10 text-amber-800 dark:text-amber-400 font-bold rounded-lg text-center text-sm">-1 (Low)</div>
              <div className="p-3 bg-rose-100/50 dark:bg-rose-500/10 text-rose-800 dark:text-rose-400 font-bold rounded-lg text-center text-sm">-3 (High)</div>

              <div className="p-3 border-b border-slate-100 dark:border-white/5 font-semibold text-sm">Marketing</div>
              <div className="p-3 bg-amber-100/50 dark:bg-amber-500/10 text-amber-800 dark:text-amber-400 font-bold rounded-lg text-center text-sm">-2 (Med)</div>
              <div className="p-3 bg-amber-100/50 dark:bg-amber-500/10 text-amber-800 dark:text-amber-400 font-bold rounded-lg text-center text-sm">-1 (Low)</div>
              <div className="p-3 bg-emerald-100/50 dark:bg-emerald-500/10 text-emerald-800 dark:text-emerald-400 font-bold rounded-lg text-center text-sm">0 (OK)</div>
              <div className="p-3 bg-emerald-100/50 dark:bg-emerald-500/10 text-emerald-800 dark:text-emerald-400 font-bold rounded-lg text-center text-sm">0 (OK)</div>
            </div>
